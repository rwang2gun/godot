...
# Phase 10: UI Atoms Foundation (CButton · Chip · Counter · SkillSlot)
...
수정:
  ...
  docs/UI_GUIDE.md            ← §3.2 Chip set_label_value 시그니처 추가 (atom API freeze — M-2)
...
## Phase 11~12가 사용할 atom API (계약 — phase 10 freeze 대상)
