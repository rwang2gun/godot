...
# campaign-50 B1 — 라이브 매니페스트 Ch1=[1,11,12,13,14,2](신규 11~14 삽입) · Ch2=[3,4,5].
...
# Ch1=[1,11,12,13,14,2]: stage1 cleared → slot1=CLEARED, slot2(id11)=PLAYABLE(prev=1 cleared),
# slot3~6(id12,13,14,2)=LOCKED, slot7~10=COMING_SOON placeholder.
func _case_chapter1_initial() -> void:
	...
	await get_tree().process_frame
	# campaign-50: 챕터당 10칸 고정(SLOTS_PER_CHAPTER). Ch1=6 실제 + placeholder 4칸.
