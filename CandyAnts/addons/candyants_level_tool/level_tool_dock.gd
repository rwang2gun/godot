...
# SkillRegistry.SKILL_SCRIPTS에 등록된 11종(= validate_stage 통과). distributor는 미등록이라 제외.
# (2026-06-18 builder→slideR/slideL 좌우 분리로 10→11종.)
...
const SKILL_IDS: Array[String] = [
	"slideR", "slideL", "blocker", "climber", "floater", "sand_mound",
